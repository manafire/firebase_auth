...
class FirebaseAuthenticationService {
    ...
    try {
      ...
      /// required to trigger the authentication flow.
        ...
        final OAuthCredential facebookAuthCredential =
            FacebookAuthProvider.credential(facebookLoginResult.accessToken!.tokenString);
  ...
  Future<FirebaseAuthenticationResult> loginAnonymously() async {
    try {
      ...
      return FirebaseAuthenticationResult.error(
          errorMessage: 'We could not log into your account at this time. Please try again.');
    }
  }
  ...
  Future<FirebaseAuthenticationResult> createAccountWithEmail({
    ...
    try {
      ...
      log?.e('A general exception has occurred. $e');
      return FirebaseAuthenticationResult.error(
          errorMessage: 'We could not create your account at this time. Please try again.');
    }
  }
  ...
  Future validatePassword(String password) async {
    try {
      ...
      final authResult =
          await firebaseAuth.currentUser?.reauthenticateWithCredential(authCredentials);
